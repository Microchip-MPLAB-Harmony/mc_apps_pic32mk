...
{"0": {
    ...
    "doc": "MCLV2 Development Board Setup for Sensored Mode PIC32MK MCA",
    "title": "MCLV2 Development Board",
    "content": " ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/docs/mclv2_pic32mk_mca_pim_sensored.html#mclv2-development-board",
    "relUrl": "/apps/docs/mclv2_pic32mk_mca_pim_sensored.html#mclv2-development-board"
  },"18": {
    "doc": "MCLV2 Development Board Setup for Sensored Mode PIC32MK MCA",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Hardware | . | mclv2_pic32mk_mca_pim.X | MCLV2 Development BoardPIC32MK MCA Motor Plugin ModuleHurst Motor with encoder | . |   |   | . Setting up MCLV2 Development Board . | Mount the PIC32MK MCM Motor Control Plug In Module on U9 header. | Place the “External Opamp Configuration” Matrix board at J14. | Motor Connections with MCLV2 Board: . | Motor | MCLV2 Board | . | Phase U | M1 | . | Phase V | M2 | . | Phase W | M3 | . | +5V | +5V | . | -5V | GND | . | A | HA | . | B | HB | . | Jumper Settings: . | JP1 - Curr, JP2 - Curr, JP3 - Curr | In order to use RS232 port for X2CScope Communication JP4 - UART, JP5 - UART | In order to use USB port for X2CScope Communication JP4 - USB, JP5 - USB | . | Power the board with a 24V DC supply using J2 or BP1-BP2. For additional safety, it is recommended to use a current limited power supply while testing this software demonstration on a non-default hardware and motor. | Complete Setup . | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/docs/mclv2_pic32mk_mca_pim_sensored.html#setting-up-the-hardware",
    "relUrl": "/apps/docs/mclv2_pic32mk_mca_pim_sensored.html#setting-up-the-hardware"
  },"19": {
    "doc": "MCLV2 Development Board Setup for Sensored Mode PIC32MK MCA",
    "title": "Running the Application",
    ...
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/docs/mclv2_pic32mk_mca_pim_sensored.html#running-the-application",
    "relUrl": "/apps/docs/mclv2_pic32mk_mca_pim_sensored.html#running-the-application"
  },"20": {
    "doc": "MCLV2 Development Board Setup for Sensored Mode PIC32MK MCA",
    "title": "MCLV2 Development Board Setup for Sensored Mode PIC32MK MCA",
    "content": " ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/docs/mclv2_pic32mk_mca_pim_sensored.html",
    "relUrl": "/apps/docs/mclv2_pic32mk_mca_pim_sensored.html"
  },"21": {
    "doc": "MCLV2 Development Board Setup for Sensorless Mode PIC32MK MCA",
    "title": "MCLV2 Development Board",
    "content": " ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/docs/mclv2_pic32mk_mca_pim_sensorless.html#mclv2-development-board",
    "relUrl": "/apps/docs/mclv2_pic32mk_mca_pim_sensorless.html#mclv2-development-board"
  },"22": {
    "doc": "MCLV2 Development Board Setup for Sensorless Mode PIC32MK MCA",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Hardware | . | mclv2_pic32mk_mca_pim.X | MCLV2 Development BoardPIC32MK MCA Motor Plugin ModuleHurst Motor with encoder | . |   |   | . Setting up MCLV2 Development Board . | Mount the PIC32MK MCA Motor Control Plug In Module on U9 header. | Place the “External Opamp Configuration” Matrix board at J14. | Motor Connections: . | Phase U - M1 | Phase V - M2 | Phase W - M3 | . | Jumper Settings: . | JP1 - Curr, JP2 - Curr, JP3 - Curr | In order to use RS232 port for X2CScope Communication JP4 - UART, JP5 - UART | In order to use USB port for X2CScope Communication JP4 - USB, JP5 - USB | . | Power the board with a 24V DC supply using J2 or BP1-BP2. For additional safety, it is recommended to use a current limited power supply while testing this software demonstration on a non-default hardware and motor. | Complete Setup . | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/docs/mclv2_pic32mk_mca_pim_sensorless.html#setting-up-the-hardware",
    "relUrl": "/apps/docs/mclv2_pic32mk_mca_pim_sensorless.html#setting-up-the-hardware"
  },"23": {
    "doc": "MCLV2 Development Board Setup for Sensorless Mode PIC32MK MCA",
    "title": "Running the Application",
    "content": ". | Build and Program the application using its IDE | Press switch S2 to start the motor | Vary potentiometer to change the speed of the motor | Press switch S2 to stop the motor | Press switch S3 to change the direction of the motor | Press switch S2 again to start the motor | Monitor graphs on X2C Scope | . Refer to the following tables for switch and LED details: . | Switch | Description | . | Switch S2 | To start or stop the motor | . | Switch S3 | To change the direction of rotation. Direction toggle command is accepted only when motor is stationary. | . |   |   | . | LED D2 Status | Description | . | OFF | Motor spin direction is “positive” | . | ON | Motor spin direction is “negative” | . |   |   | . | LED D17 Status | Description | . | OFF | No fault | . | ON | Fault is detected | . |   |   | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/docs/mclv2_pic32mk_mca_pim_sensorless.html#running-the-application",
    "relUrl": "/apps/docs/mclv2_pic32mk_mca_pim_sensorless.html#running-the-application"
  },"24": {
    "doc": "MCLV2 Development Board Setup for Sensorless Mode PIC32MK MCA",
    "title": "MCLV2 Development Board Setup for Sensorless Mode PIC32MK MCA",
    "content": " ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/docs/mclv2_pic32mk_mca_pim_sensorless.html",
    "relUrl": "/apps/docs/mclv2_pic32mk_mca_pim_sensorless.html"
  },"25": {
    ...
    "title": "MCLV2 Development Board",
    "content": " ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/docs/mclv2_tc1_pic32mk_mcf_pim_sensorless.html#mclv2-development-board",
    "relUrl": "/apps/docs/mclv2_tc1_pic32mk_mcf_pim_sensorless.html#mclv2-development-board"
  },"42": {
    "doc": "MCLV2 Development Board Setup for Sensorless Mode",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Hardware | . | mclv2_pic32mk_mcf_pim.X | MCLV2 Development BoardPIC32MK MCF Motor Plugin ModuleEBM-PAPST ECI 6320-K1-B00 motor | . Modify the MCLV2 Development Board . | Modify the MCLV2 development board for higher current capability- TC1 modifications. Refer the MCLV2 Development Board modification guide for more details. | . Setting up MCLV2 Development Board . | Mount the PIC32MK MCF Motor Control Plug In Module on U9 header. | Place the “External Opamp Configuration” Matrix board at J14. | Motor Connections: . | Phase U - M1 | Phase V - M2 | Phase W - M3 | . | Jumper Settings: . | JP1 - Curr, JP2 - Curr, JP3 - Curr | In order to use RS232 port for X2CScope Communication JP4 - UART, JP5 - UART | In order to use USB port for X2CScope Communication JP4 - USB, JP5 - USB | . | Power the board with a 24V DC supply using J2 or BP1-BP2. For additional safety, it is recommended to use a current limited power supply while testing this software demonstration on a non-default hardware and motor. | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/docs/mclv2_tc1_pic32mk_mcf_pim_sensorless.html#setting-up-the-hardware",
    "relUrl": "/apps/docs/mclv2_tc1_pic32mk_mcf_pim_sensorless.html#setting-up-the-hardware"
  },"43": {
    "doc": "MCLV2 Development Board Setup for Sensorless Mode",
    "title": "Running the Application",
    "content": ". | Build and Program the application with src/pic32mk_mcf_zsmt_firmware.hexusing Microchip’s IPE. | Press switch S2 to start the motor | Vary potentiometer to change the speed of the motor | Press switch S2 to stop the motor | Press switch S2 again to start the motor | Monitor graphs on X2C Scope | . Refer to the following tables for switch and LED details: . | Switch | Description | . | Switch S2 | To start or stop the motor | . | LED D17 Status | Description | . | OFF | No fault | . | ON | Fault is detected | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/docs/mclv2_tc1_pic32mk_mcf_pim_sensorless.html#running-the-application",
    "relUrl": "/apps/docs/mclv2_tc1_pic32mk_mcf_pim_sensorless.html#running-the-application"
  },"44": {
    "doc": "MCLV2 Development Board Setup for Sensorless Mode",
    "title": "MCLV2 Development Board Setup for Sensorless Mode",
    "content": " ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/docs/mclv2_tc1_pic32mk_mcf_pim_sensorless.html",
    "relUrl": "/apps/docs/mclv2_tc1_pic32mk_mcf_pim_sensorless.html"
  },"45": {
    "doc": "MCLV2 Development Board Setup for Sensorless Mode",
    "title": "MCLV2 Development Board",
    "content": " ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/docs/mclv2_tc1_pic32mk_mcm_pim_sensorless.html#mclv2-development-board",
    "relUrl": "/apps/docs/mclv2_tc1_pic32mk_mcm_pim_sensorless.html#mclv2-development-board"
  },"46": {
    "doc": "MCLV2 Development Board Setup for Sensorless Mode",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Hardware | . | mclv2_pic32mk_mcm_pim.X | MCLV2 Development BoardPIC32MK MCM Motor Plugin ModuleEBM-PAPST ECI 6320-K1-B00 motor | . Modify the MCLV2 Development Board . | Modify the MCLV2 development board for higher current capability- TC1 modifications. Refer the MCLV2 Development Board modification guide for more details. | . Setting up MCLV2 Development Board . | Mount the PIC32MK MCM Motor Control Plug In Module on U9 header. | Place the “External Opamp Configuration” Matrix board at J14. | Motor Connections: . | Phase U - M1 | Phase V - M2 | Phase W - M3 | . | Jumper Settings: . | JP1 - Curr, JP2 - Curr, JP3 - Curr | In order to use RS232 port for X2CScope Communication JP4 - UART, JP5 - UART | In order to use USB port for X2CScope Communication JP4 - USB, JP5 - USB | . | Power the board with a 24V DC supply using J2 or BP1-BP2. For additional safety, it is recommended to use a current limited power supply while testing this software demonstration on a non-default hardware and motor. | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/docs/mclv2_tc1_pic32mk_mcm_pim_sensorless.html#setting-up-the-hardware",
    "relUrl": "/apps/docs/mclv2_tc1_pic32mk_mcm_pim_sensorless.html#setting-up-the-hardware"
  },"47": {
    "doc": "MCLV2 Development Board Setup for Sensorless Mode",
    "title": "Running the Application",
    "content": ". | Build and Program the application with src/pic32mk_mcm_zsmt_firmware.hexusing Microchip’s IPE. | Press switch S2 to start the motor | Vary potentiometer to change the speed of the motor | Press switch S2 to stop the motor | Press switch S2 again to start the motor | Monitor graphs on X2C Scope | . Refer to the following tables for switch and LED details: . | Switch | Description | . | Switch S2 | To start or stop the motor | . | LED D17 Status | Description | . | OFF | No fault | . | ON | Fault is detected | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/docs/mclv2_tc1_pic32mk_mcm_pim_sensorless.html#running-the-application",
    "relUrl": "/apps/docs/mclv2_tc1_pic32mk_mcm_pim_sensorless.html#running-the-application"
  },"48": {
    "doc": "MCLV2 Development Board Setup for Sensorless Mode",
    "title": "MCLV2 Development Board Setup for Sensorless Mode",
    "content": " ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/docs/mclv2_tc1_pic32mk_mcm_pim_sensorless.html",
    "relUrl": "/apps/docs/mclv2_tc1_pic32mk_mcm_pim_sensorless.html"
  },"49": {
    "doc": "License",
    "title": "License",
    ...
    "title": "Sensorless FOC on PMSM using Sliding mode observer",
    "content": "This example application shows how to control the Permanent Magnet Synchronous Motor (PMSM) with sliding mode observer based Field Oriented Control (FOC) on a PIC32MK Micro-controller. ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/pmsm_foc_smo_pic32_mk/readme.html#sensorless-foc-on-pmsm-using-sliding-mode-observer",
    "relUrl": "/apps/pmsm_foc_smo_pic32_mk/readme.html#sensorless-foc-on-pmsm-using-sliding-mode-observer"
  },"51": {
    "doc": "PMSM FOC using sliding mode observer",
    "title": "Description",
    "content": "Permanent Magnet Synchronous Motor (PMSM) is controlled using Field Oriented Control (FOC). Rotor position and speed is determined using sliding mode observer. Motor start/stop operation is controlled by the switch and motor speed can be changed by the on-board potentiometer. Waveforms and variables can be monitored runtime using X2CScope. ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/pmsm_foc_smo_pic32_mk/readme.html#description",
    "relUrl": "/apps/pmsm_foc_smo_pic32_mk/readme.html#description"
  },"52": {
    "doc": "PMSM FOC using sliding mode observer",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/pmsm_foc_smo_pic32_mk . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | Demo User Guide | . | mclv2_pic32mk_mcm_pim.X | MPLABX project for MCLV2 board with PIC32MK MCF PIM | MCLV2 with PIC32MK MCM PIM | . | mchv3_pic32mk_mcf_pim.X | MPLABX project for MCHV3 board with PIC32MK MCF PIM | MCHV3 with PIC32MK MCM PIM | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/pmsm_foc_smo_pic32_mk/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/pmsm_foc_smo_pic32_mk/readme.html#downloading-and-building-the-application"
  },"53": {
    "doc": "PMSM FOC using sliding mode observer",
    "title": "PMSM FOC using sliding mode observer",
    "content": ". ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/pmsm_foc_smo_pic32_mk/readme.html",
    "relUrl": "/apps/pmsm_foc_smo_pic32_mk/readme.html"
  },"54": {
    "doc": "PMSM FOC using ZS/MT Hybrid Estimator",
    "title": "Sensorless FOC on PMSM using ZS/MT Hybrid Estimator",
    "content": "This example application shows how to control the Permanent Magnet Synchronous Motor (PMSM) with ZS/MT Hybrid Estimator based Field Oriented Control (FOC) on a PIC32MK Micro-controller. ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/pmsm_foc_zsmt_hybrid_pic32_mk/readme.html#sensorless-foc-on-pmsm-using-zsmt-hybrid-estimator",
    "relUrl": "/apps/pmsm_foc_zsmt_hybrid_pic32_mk/readme.html#sensorless-foc-on-pmsm-using-zsmt-hybrid-estimator"
  },"55": {
    "doc": "PMSM FOC using ZS/MT Hybrid Estimator",
    "title": "Description",
    "content": "Permanent Magnet Synchronous Motor (PMSM) is controlled using Field Oriented Control (FOC). Rotor position and speed is determined using a hybrid estimator with high frequency injection (ZS/MT) for low speed and back EMF observer with PLL estimator for high speed control. Motor start/stop operation is controlled by the switch and motor speed can be changed by the on-board potentiometer. Waveforms and variables can be monitored runtime using X2CScope. Key features enabled in this project are: . | Dual shunt current measurement | Speed control loop | Hybrid ZS/MT | . This demonstration project contains dummy libraries for IPD and ZS/MT hybrid and IPD algorithms. Kindly contact Microchip Local Sales to get access to actual libraries. You can still use pic32mk_mcf_zsmt_firmware.hex for PIC32MK MCF devices, and pic32mk_mcm_zsmt_firmwarefor PIC32MK MCM devices to evaluate the project. Note: Evaluation of pic32mk_mcm_zsmt_firmware for PIC32MK MCM requires PIM modification. Remove the external op-amp circuitary for current measurement. Contact us in case of queries. ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/pmsm_foc_zsmt_hybrid_pic32_mk/readme.html#description",
    "relUrl": "/apps/pmsm_foc_zsmt_hybrid_pic32_mk/readme.html#description"
  },"56": {
    "doc": "PMSM FOC using ZS/MT Hybrid Estimator",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/pmsm_foc_smo_pic32_mk . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | Demo User Guide | . | mclv2_pic32mk_mcm_pim.X | MPLABX project for MCLV2 board with PIC32MK MCF PIM | MCLV2 with PIC32MK MCM PIM | . | mclv2_pic32mk_mcf_pim.X | MPLABX project for MCLV2 board with PIC32MK MCF PIM | MCLV2 with PIC32MK MCF PIM | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/pmsm_foc_zsmt_hybrid_pic32_mk/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/pmsm_foc_zsmt_hybrid_pic32_mk/readme.html#downloading-and-building-the-application"
  },"57": {
    "doc": "PMSM FOC using ZS/MT Hybrid Estimator",
    "title": "PMSM FOC using ZS/MT Hybrid Estimator",
    "content": ". ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/pmsm_foc_zsmt_hybrid_pic32_mk/readme.html",
    "relUrl": "/apps/pmsm_foc_zsmt_hybrid_pic32_mk/readme.html"
  },"58": {
    ...
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/mcp_pmsm_foc_pll_estimator_pic32_mk/readme.html#pmsm-foc-using-pll-estimator",
    "relUrl": "/apps/mcp_pmsm_foc_pll_estimator_pic32_mk/readme.html#pmsm-foc-using-pll-estimator"
  },"59": {
    "doc": "PMSM FOC using PLL Estimator",
    "title": "Description",
    "content": "Permanent Magnet Synchronous Motor (PMSM) is controlled using Field Oriented Control (FOC). Rotor position and speed is determined using PLL based estimator. Motor start/stop operation is controlled by the switch and motor speed can be changed by the on-board potentiometer. Waveforms and variables can be monitored runtime using X2CScope. ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/mcp_pmsm_foc_pll_estimator_pic32_mk/readme.html#description",
    "relUrl": "/apps/mcp_pmsm_foc_pll_estimator_pic32_mk/readme.html#description"
  },"60": {
    "doc": "PMSM FOC using PLL Estimator",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/mcp_pmsm_foc_encoder_pic32_mk . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | Demo User Guide | . | mclv2_pic32mk_mcf_pim.X | MPLABX project for MCLV2 board with PIC32MK MCF PIM | MCLV2 with PIC32MK MCF PIM | . | mclv2_pic32mk_mcm_pim.X | MPLABX project for MCLV2 board with PIC32MK MCM PIM | MCLV2 with PIC32MK MCM PIM | . | mclv2_pic32mk_mca_pim.X | MPLABX project for MCLV2 board with PIC32MK MCA PIM | MCLV2 with PIC32MK MCA PIM | . | mchv3_pic32mk_mcf_pim.X | MPLABX project for MCHV3 board with PIC32MK MCF PIM | MCHV3 with PIC32MK MCF PIM | . | mchv3_pic32mk_mcm_pim.X | MPLABX project for MCHV3 board with PIC32MK MCM PIM | MCHV3 with PIC32MK MCM PIM | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/mcp_pmsm_foc_pll_estimator_pic32_mk/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/mcp_pmsm_foc_pll_estimator_pic32_mk/readme.html#downloading-and-building-the-application"
  },"61": {
    "doc": "PMSM FOC using PLL Estimator",
    "title": "PMSM FOC using PLL Estimator",
    "content": ". ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/mcp_pmsm_foc_pll_estimator_pic32_mk/readme.html",
    "relUrl": "/apps/mcp_pmsm_foc_pll_estimator_pic32_mk/readme.html"
  },"62": {
    "doc": "PMSM FOC using Quadrature Encoder",
    "title": "PMSM FOC using Quadrature Encoder",
    "content": "This example application shows how to control the Permanent Magnet Synchronous Motor (PMSM) with Quadrature Encoder based Field Oriented Control (FOC) on a PIC32MK microcontroller. ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/mcp_pmsm_foc_encoder_pic32_mk/readme.html#pmsm-foc-using-quadrature-encoder",
    "relUrl": "/apps/mcp_pmsm_foc_encoder_pic32_mk/readme.html#pmsm-foc-using-quadrature-encoder"
  },"63": {
    "doc": "PMSM FOC using Quadrature Encoder",
    "title": "Description",
    ...
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/mcp_pmsm_foc_encoder_pic32_mk/readme.html#description",
    "relUrl": "/apps/mcp_pmsm_foc_encoder_pic32_mk/readme.html#description"
  },"64": {
    "doc": "PMSM FOC using Quadrature Encoder",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/mcp_pmsm_foc_encoder_pic32_mk . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | Demo User Guide | . | mclv2_pic32mk_mcf_pim.X | MPLABX project for MCLV2 board with PIC32MK MCF PIM | MCLV2 with PIC32MK MCF PIM | . | mclv2_pic32mk_mcm_pim.X | MPLABX project for MCLV2 board with PIC32MK MCM PIM | MCLV2 with PIC32MK MCM PIM | . | mclv2_pic32mk_mca_pim.X | MPLABX project for MCLV2 board with PIC32MK MCA PIM | MCLV2 with PIC32MK MCA PIM | . | mchv3_pic32mk_mcf_pim.X | MPLABX project for MCHV3 board with PIC32MK MCF PIM | MCHV3 with PIC32MK MCF PIM | . | mchv3_pic32mk_mcm_pim.X | MPLABX project for MCHV3 board with PIC32MK MCM PIM | MCHV3 with PIC32MK MCM PIM | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/mcp_pmsm_foc_encoder_pic32_mk/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/mcp_pmsm_foc_encoder_pic32_mk/readme.html#downloading-and-building-the-application"
  },"65": {
    "doc": "PMSM FOC using Quadrature Encoder",
    "title": "PMSM FOC using Quadrature Encoder",
    "content": ". ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/mcp_pmsm_foc_encoder_pic32_mk/readme.html",
    "relUrl": "/apps/mcp_pmsm_foc_encoder_pic32_mk/readme.html"
  },"66": {
    "doc": "Release notes",
    ...
    "doc": "Release notes",
    "title": "Microchip MPLAB® Harmony 3 Motor Control Application Examples for PIC32MK family v3.4.0",
    "content": "Applications . | Development Board | Number of Applications | . | dsPICDEM™ MCLV-2 Low Voltage Development Board | 9 | . | dsPICDEM™ MCHV-3 High Voltage Development Board | 5 | . New Features . | Added SMO based sensorless FOC project with PIC32MK MCM and dsPICDEM MCLV2 board | Added ZS/MT Hybrid estimator based sensorless FOC project with PIC32MK MCM and dsPICDEM MCLV2 board | Added ZS/MT Hybrid estimator based sensorless FOC project with PIC32MK MCF and dsPICDEM MCLV2 board | MISRA-C Compliance for motor control files | Deprecate static projects for PLL based sensorless FOC project | Deprecate static projects for encoder based sensored FOC project | . Known Issues . | same as v3.1.0 | . Required MPLAB Harmony v3 Modules . | bsp v3.17.0 | motor_control v3.10.0 | x2c v1.4.0 | . Development Tools . | MPLAB X IDE v6.10 | MPLAB XC32 C/C++ Compiler v4.30 | MPLAB X IDE plug-ins: . | MPLAB Code Configurator (MCC) v5.3.7 | X2CScope v1.3.3. | . | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/release_notes.html#microchip-mplab-harmony-3-motor-control-application-examples-for-pic32mk-family-v340",
    "relUrl": "/release_notes.html#microchip-mplab-harmony-3-motor-control-application-examples-for-pic32mk-family-v340"
  },"68": {
    "doc": "Release notes",
    "title": "Microchip MPLAB® Harmony 3 Motor Control Application Examples for PIC32MK family v3.3.0",
    "content": "Applications . | Development Board | Number of Applications | . | dsPICDEM™ MCLV-2 Low Voltage Development Board | 8 | . | dsPICDEM™ MCHV-3 High Voltage Development Board | 4 | . New Features . | Added PLL based sensorless FOC firmware for MCHV3 in Harmony QSpin | Added Encoder based sensored FOC firmware for MCHV3 in Harmony QSpin | Added support for PIC32MK MCA - added PLL and encoder based FOC firmware for MCLV2 in Harmony Qspin | . Known Issues . | same as v3.1.0 | . Required MPLAB Harmony v3 Modules . | bsp v3.14.0 | motor_control v3.9.0 | x2c v1.3.0 | mcc H3 Library v1.1.5 | . Development Tools . | MPLAB X IDE v6.00 | MPLAB XC32 C/C++ Compiler v4.10 | MPLAB X IDE plug-ins: . | MPLAB Code Configurator (MCC) v5.1.17 | X2CScope v1.3.3. | . | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/release_notes.html#microchip-mplab-harmony-3-motor-control-application-examples-for-pic32mk-family-v330",
    "relUrl": "/release_notes.html#microchip-mplab-harmony-3-motor-control-application-examples-for-pic32mk-family-v330"
  },"69": {
    "doc": "Release notes",
    "title": "Hardware",
    "content": ". | For MCHV3 board programming and debugging, use High Voltage Motor Control Isolated Debugger Card | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/release_notes.html#hardware",
    "relUrl": "/release_notes.html#hardware"
  },"70": {
    "doc": "Release notes",
    "title": "Microchip MPLAB® Harmony 3 Motor Control Application Examples for PIC32MK family v3.2.0",
    "content": "Applications . | Development Board | Number of Applications | . | dsPICDEM™ MCLV-2 Low Voltage Development Board | 6 | . | dsPICDEM™ MCHV-3 High Voltage Development Board | 4 | . New Features . | Added Motor Control Plant generated PLL based sensorless FOC firmware for MCLV2 | Added Motor Control Plant generated Encoder based sensored FOC firmware for MCLV2 | . Known Issues . | same as v3.1.0 | . Required MPLAB Harmony v3 Modules . | csp v3.11.0 | x2c v1.2.0 | bsp v3.11.1 | motor_control v3.8.0 | dev_packs v3.11.0 | mcc v1.1.0 | . Development Tools . | MPLAB X IDE v6.00 | MPLAB XC32 C/C++ Compiler v4.00 | MPLAB X IDE plug-ins: . | MPLAB Code Configurator (MCC) v5.1.2 | X2CScope v1.3.0. | . | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/release_notes.html#microchip-mplab-harmony-3-motor-control-application-examples-for-pic32mk-family-v320",
    "relUrl": "/release_notes.html#microchip-mplab-harmony-3-motor-control-application-examples-for-pic32mk-family-v320"
  },"71": {
    "doc": "Release notes",
