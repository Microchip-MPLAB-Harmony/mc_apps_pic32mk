...
{"0": {
    ...
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/pmsm_foc_encoder_pic32_mk/readme.html#software-design-1",
    "relUrl": "/apps/pmsm_foc_encoder_pic32_mk/readme.html#software-design-1"
  },"40": {
    "doc": "PMSM FOC using Quadrature Encoder",
    ...
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/mcp_pmsm_foc_pll_estimator_pic32_mk/readme.html#mhc-project-configurations",
    "relUrl": "/apps/mcp_pmsm_foc_pll_estimator_pic32_mk/readme.html#mhc-project-configurations"
  },"52": {
    "doc": "PMSM FOC using PLL Estimator",
    "title": "Project Details",
    "content": "For details refer Motor Control Plant . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/mcp_pmsm_foc_pll_estimator_pic32_mk/readme.html#project-details",
    "relUrl": "/apps/mcp_pmsm_foc_pll_estimator_pic32_mk/readme.html#project-details"
  },"53": {
    "doc": "PMSM FOC using PLL Estimator",
    "title": "Development Kits",
    "content": "MCLV2 with PIC32MK Family Motor Control PIM . Downloading and building the application . To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/mcp_pmsm_foc_encoder_pic32_mk . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | Demo User Guide | . | mclv2_pic32mk_mcf_pim.X | MPLABX project for MCLV2 board with PIC32MK MCF PIM | MCLV2 with PIC32MK MCF PIM | . | mclv2_pic32mk_mcm_pim.X | MPLABX project for MCLV2 board with PIC32MK MCM PIM | MCLV2 with PIC32MK MCM PIM | . |   |   |   | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/mcp_pmsm_foc_pll_estimator_pic32_mk/readme.html#development-kits",
    "relUrl": "/apps/mcp_pmsm_foc_pll_estimator_pic32_mk/readme.html#development-kits"
  },"54": {
    "doc": "PMSM FOC using PLL Estimator",
    "title": "PMSM FOC using PLL Estimator",
    "content": ". ",
    ...
    "title": "MHC Project Configurations",
    "content": ". | PMSM_FOC: . This component configures FOC algorithm parameters, motor parameters and motor control board parameters. It connects to underlying peripheral libraries ADCHS and MCPWM. This components auto configures ADC channels and PWM channels as per PMSM_FOC component configurations. | ADCHS Peripheral: . The ADCHS is used to measure analog quantities. Four channels are used to measure the Phase Current U, the Phase Current V, the DC Bus Voltage and the Potentiometer. Conversion is triggered at the PWM (zero match + offset of the switch delay) . | MCPWM Peripheral: . This peripheral is used to generated three phase synchronous PWM waveforms. Fault functionality is also enabled to switch off the output waveforms asynchronously. | QEI Peripheral: . This peripheral is used to decode the rotor position and speed from quadrature encoder signals. | X2CScope: . This component adds X2C scope protocol code. This uses UART to communicate to the host PC. X2CScope allows user to monitor variables runtime. | UART Peripheral: . The UART is used for X2CScope communication to observe graphs and variable values in run time . | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/mcp_pmsm_foc_encoder_pic32_mk/readme.html#mhc-project-configurations",
    "relUrl": "/apps/mcp_pmsm_foc_encoder_pic32_mk/readme.html#mhc-project-configurations"
  },"58": {
    "doc": "PMSM FOC using Quadrature Encoder",
    "title": "Project Details",
    "content": "For details refer Motor Control Plant . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/mcp_pmsm_foc_encoder_pic32_mk/readme.html#project-details",
    "relUrl": "/apps/mcp_pmsm_foc_encoder_pic32_mk/readme.html#project-details"
  },"59": {
    "doc": "PMSM FOC using Quadrature Encoder",
    "title": "Development Kits",
    "content": "MCLV2 with PIC32MK Family Motor Control PIM . Downloading and building the application . To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/mcp_pmsm_foc_encoder_pic32_mk . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | Demo User Guide | . | mclv2_pic32mk_mcf_pim.X | MPLABX project for MCLV2 board with PIC32MK MCF PIM | MCLV2 with PIC32MK MCF PIM | . | mclv2_pic32mk_mcm_pim.X | MPLABX project for MCLV2 board with PIC32MK MCM PIM | MCLV2 with PIC32MK MCM PIM | . |   |   |   | . ",
    "url": "http://localhost:4000/mc_apps_pic32mk/apps/mcp_pmsm_foc_encoder_pic32_mk/readme.html#development-kits",
    "relUrl": "/apps/mcp_pmsm_foc_encoder_pic32_mk/readme.html#development-kits"
  },"60": {
    "doc": "PMSM FOC using Quadrature Encoder",
    "title": "PMSM FOC using Quadrature Encoder",
    "content": ". ",
